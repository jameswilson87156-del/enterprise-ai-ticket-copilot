#!/usr/bin/env python3
"""Offline structured-output decision smoke evaluation for demo cases.

This script does not call a Provider, does not read project runtime data, and does not
modify the existing RAG baseline files. It evaluates deterministic citation/abstention
expectations encoded in data/eval/structured_decision_eval_cases.jsonl.
"""
